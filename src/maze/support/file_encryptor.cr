...
module Maze::Support
  ...
  module FileEncryptor
    ...
    def self.encryption_key(file = FILE_PATH)
      ...
      raise Maze::Exceptions::EncryptionKeyMissing.new(file, ENCRYPT_ENV)
    end
  end
end
