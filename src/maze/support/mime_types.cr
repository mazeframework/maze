module Maze
  module Support
    module MimeTypes
      ...
      #
      # ```
      # Maze::Support::Mime.mime_type("json")                  # => "application/json"
      # Maze::Support::Mime.mime_type(".jpg")                  # => "image/jpeg"
      # Maze::Support::Mime.mime_type("unknown")               # => "application/octet-stream"
      # Maze::Support::Mime.mime_type("unknown", "text/plain") # => "text/plain"
      # ```
