module Maze
  module WebSockets
    ...
    abstract struct ClientSocket
      ...
      protected getter raw_params : Maze::Router::Params
      protected getter params : Maze::Validators::Params
      protected getter session : Maze::Router::Session::AbstractStore?
      protected getter cookies : Maze::Router::Cookies::Store?
      ...
      def initialize(@socket, @context)
        ...
        @params = Maze::Validators::Params.new(@raw_params)
      ...
      protected def on_message(message)
        if @socket.closed?
          Maze.logger.error "Ignoring message sent to closed socket"
        else
