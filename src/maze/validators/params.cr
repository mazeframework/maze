module Maze::Validators
  ...
  class BaseRule
    ...
    def apply(params : Maze::Router::Params)
    ...
    private def call_predicate(params : Maze::Router::Params)
      @value = params[@field]
  ...
  class Params
    getter raw_params : Maze::Router::Params
    ...
    def validate!
      ...
      raise Maze::Exceptions::Validator::ValidationFailed.new errors
    end
