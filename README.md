...
Maze has a number of fundamental differences from Amber which meant creating a new framework was a better option than trying to modify Amber whilst retaining Amber's core principles. These can be summarized as;
...
With Amber, anyone coming from a Rails background will feel right at home as the Amber application layout has many similarities with Rails, e.g. Model, Views and Controllers are contained in app/models, app/views and app/controllers directories respectively.
